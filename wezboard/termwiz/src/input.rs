...
use std::fmt::Write;
use wezboard_input_types::ctrl_mapping;

pub use wezboard_input_types::Modifiers;
...
pub use wezboard_escape_parser::csi::MouseButtons;
            ...
            match self.state {
                InputState::Pasting(offset) => {
                    ...
                    if let Some(idx) = self.buf.find_subsequence(offset, end_paste) {
                        ...
                        // <https://github.com/termsurf/termsurf/pull/1832>
                        self.state =
