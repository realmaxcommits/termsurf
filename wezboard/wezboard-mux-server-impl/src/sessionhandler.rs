...
use url::Url;
use wezboard_term::terminal::Alert;
        ...
        match decoded.pdu {
            ...
            Pdu::SetClientId(SetClientId {
                ...
                if is_proxy {
                    ...
                    // on from the `wezboard cli list-clients` information
                ...
                match std::env::current_exe().context("resolving current_exe") {
                    ...
                    Ok(executable_path) => {
                        send_response(Ok(Pdu::GetCodecVersionResponse(GetCodecVersionResponse {
                            ...
                            version_string: config::wezboard_version().to_owned(),
                            executable_path,
                            config_file_path: std::env::var_os("WEZBOARD_CONFIG_FILE")
                                .map(Into::into),
                        })))
                    }
                }
