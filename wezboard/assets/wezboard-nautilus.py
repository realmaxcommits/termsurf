...
class OpenInWezboardAction(GObject.GObject, Nautilus.MenuProvider):
    def __init__(self):
        super().__init__()
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in Wezboard',
            icon='com.termsurf.wezboard')
    ...
    def get_file_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='WezboardNautilus::open_in_wezboard', paths=paths)]
        else:
            return []
    ...
    def get_background_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='WezboardNautilus::open_folder_in_wezboard', paths=paths)]
        else:
            return []
