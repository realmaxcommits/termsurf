# `wezboard cli send-text`

*Run `wezboard cli send-text --help` to see more help*
...
```
$ wezboard cli send-text "hello there"
```
...
```
$ echo hello there | wezboard cli send-text
```
...
```console
{% include "../../examples/cmd-synopsis-wezboard-cli-send-text--help.txt" %}
```
