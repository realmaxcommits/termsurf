...
*Run `wezboard cli list --help` to see more help*
...
WINID TABID PANEID WORKSPACE SIZE  TITLE                          CWD
    0     0      0 default   80x24 wezboard cli list  -- wez@foo:~ file://foo/home/wez/
```
...
[
  {
    ...
    "title": "wezboard cli list --format json -- wez@foo:~",
...
```console
{% include "../../examples/cmd-synopsis-wezboard-cli-list--help.txt" %}
```
