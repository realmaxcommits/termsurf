# `wezboard cli list-clients`

*Run `wezboard cli list-clients --help` to see more help*
...
```
$ wezboard cli list-clients --format json
[
  {
    "username": "wez",
    "hostname": "foo",
...
```console
{% include "../../examples/cmd-synopsis-wezboard-cli-list-clients--help.txt" %}
```
