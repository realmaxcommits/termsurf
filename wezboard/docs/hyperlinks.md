wezboard has support for both implicit and explicit hyperlinks.
...
config.hyperlink_rules = wezboard.default_hyperlink_rules()
...
-- ( "nvim-treesitter/nvim-treesitter" | wbthomason/packer.nvim | termsurf/termsurf | "termsurf/termsurf.git" )
...
[default_hyperlink_rules](config/lua/wezboard/default_hyperlink_rules.md).


### Explicit Hyperlinks

wezboard supports the relatively new [Hyperlinks in Terminal
