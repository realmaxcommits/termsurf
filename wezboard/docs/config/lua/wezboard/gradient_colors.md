---
title: wezboard.gradient_colors
tags:
 - color
---

# `wezboard.gradient_colors(gradient, num_colors)`
...
```
> wezboard.gradient_colors({preset="Rainbow"}, 4)
...
[wezboard.color.gradient](../wezboard.color/gradient.md) and that name
