---
title: wezboard.default_ssh_domains
tags:
 - ssh
 - multiplexing
---

# wezboard.default_ssh_domains()
...
require wezboard to be installed on the remote host, while the
...
are unix machines, you might want to inform wezboard of that
