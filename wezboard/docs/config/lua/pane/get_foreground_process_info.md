...
* Querying the path may fail for a variety of reasons outside of the control of Wezboard
* Querying process information has some runtime overhead, which may cause wezboard to slow down if over-used.
