...
more scope in earlier versions of wezboard, but today it allows three
possible values:
...
Wezboard will automatically select `Software` if it detects that it is
...
The WebGpu front end allows wezboard to use GPU acceleration provided by
