...
You can use the [wezboard.gui.enumerate_gpus()](../wezboard.gui/enumerate_gpus.md) function
...
local config = {}
local gpus = wezboard.gui.enumerate_gpus()
...
for _, gpu in ipairs(wezboard.gui.enumerate_gpus()) do
