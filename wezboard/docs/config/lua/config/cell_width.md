...
selecting a font using [wezboard.font](../wezboard/font.md) or
[wezboard.font_with_fallback](../wezboard/font_with_fallback.md) as that will
...
wezboard considers to be the cell boundaries. When rendering monospace, wezboard
