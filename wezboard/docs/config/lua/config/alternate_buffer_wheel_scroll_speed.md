...
In this mode, if the application hasn't enabled mouse reporting, wezboard will
...
In versions of wezboard prior to this configuration option being available, the
