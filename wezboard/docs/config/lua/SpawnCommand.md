...
wezboard.action.SpawnCommandInNewWindow {
  ...
  -- If omitted, wezboard will infer a value based on the active pane
  ...
  -- wezboard using `wezboard connect` or `wezboard serial` then the default
  ...
  -- wezboard.mux.spawn_window, SpawnCommandInNewWindow
  position = {
    x = 10,
    y = 300,
