# `wezboard.color.get_builtin_schemes()`

{{since('20220807-113146-c2fee766')}}

(In earlier releases, you can use [wezboard.get_builtin_color_schemes()](../wezboard/get_builtin_color_schemes.md))
...
local schemes = {}
for name, scheme in pairs(wezboard.color.get_builtin_schemes()) do
...
local scheme = wezboard.color.get_builtin_schemes()['Gruvbox Light']
...
local function dark_schemes()
  local schemes = wezboard.color.get_builtin_schemes()
  local dark = {}
