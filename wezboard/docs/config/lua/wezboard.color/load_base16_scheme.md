# `wezboard.color.load_base16_scheme(file_name)`
...
Note that wezboard ships with the base16 color schemes that were referenced via
...
that was created after your version of wezboard was built.
...
```
> colors, metadata = wezboard.color.load_base16_scheme("/tmp/cupcake.yaml")
> print(colors)
