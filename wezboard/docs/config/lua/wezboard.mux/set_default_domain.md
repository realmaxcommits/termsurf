# `wezboard.mux.set_default_domain(MuxDomain)`
...
default domain that may have happened as a result of starting wezboard via
`wezboard connect` or `wezboard serial`.
