...
Defining an event handler doesn't alter wezboard's handling of the bell;
...
wezboard.on('bell', function(window, pane)
  wezboard.log_info('the bell was rung in pane ' .. pane:pane_id() .. '!')
end)
