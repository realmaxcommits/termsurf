...
use wezboard_term::config::BidiMode;
...
impl wezboard_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> wezboard_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => wezboard_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => wezboard_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => wezboard_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                wezboard_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                wezboard_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }
