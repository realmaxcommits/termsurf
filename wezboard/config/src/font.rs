        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(wezboard_dynamic::Error::NoConversion {
...
impl std::fmt::Display for FontAttributes {
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> Result<(), std::fmt::Error> {
        write!(
            fmt,
            "wezboard.font('{}', {{weight={}, stretch='{}', style={}}})",
...
impl TextStyle {
    ...
    ///
    /// <https://github.com/termsurf/termsurf/issues/456>
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<wezboard_term::Intensity>,
    ...
    /// "Double".
    pub underline: Option<wezboard_term::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<wezboard_term::Blink>,
