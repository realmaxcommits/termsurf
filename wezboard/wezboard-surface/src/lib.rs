...
use wezboard_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use wezboard_cell::image::ImageCell;
use wezboard_cell::{Cell, CellAttributes};
...
mod test {
    use super::*;
    use alloc::sync::Arc;
    use wezboard_cell::color::AnsiColor;
    use wezboard_cell::image::ImageData;
    use wezboard_cell::{AttributeChange, Intensity};
