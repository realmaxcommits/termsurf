...
use ::image::RgbaImage;
use wezboard_cell::color::RgbColor;
use wezboard_cell::image::ImageDataType;
use wezboard_escape_parser::{Sixel, SixelData};
        ...
        for d in &sixel.data {
            match d {
                ...
                SixelData::DefineColorMapHSL {
                    ...
                    // https://github.com/termsurf/termsurf/issues/775
