...
//! used by [wezboard](https://wezboard.org/).  The home for this
//! crate is in the wezboard repo and development is tracked at
...
use wezboard_surface::SequenceNo;
...
pub use wezboard_cell::*;
pub use wezboard_surface::line::*;
...
pub struct CursorPosition {
    ...
    pub shape: wezboard_surface::CursorShape,
    pub visibility: wezboard_surface::CursorVisibility,
