...
use wezboard_surface::{Line, SequenceNo};
...
impl Default for NewlineCanon {
    fn default() -> Self {
        ...
        //
        // To come to a compromise, if wezboard is running on Windows then we'll
        ...
        if cfg!(windows) {
            ...
            // <https://github.com/termsurf/termsurf/issues/1575>
            Self::CarriageReturn
        }
    }
}
