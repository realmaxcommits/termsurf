# wezboard-bidi - a pure Rust bidi implementation

This crate provides an implementation of the *The Unicode Bidirectional
Algorithm (UBA)* in Rust.

This crate was developed for use in wezboard but does not depend on
other code in wezboard.
...
Copyright © 2022-Present Wez Longboard.
