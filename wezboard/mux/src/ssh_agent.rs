...
/// AgentProxy manages an agent.PID symlink in the wezboard runtime
/// directory.
...
///
/// As a further complication, when a wezboard proxy client is
...
impl AgentProxy {
    ...
    fn update_now(&self) {
        ...
        clients.sort_by(|a, b| {
            ...
            // in wezboard-mux-server-impl/src/sessionhandler.rs
