...
use thiserror::*;
use wezboard_term::{Clipboard, ClipboardSelection, DownloadHandler, TerminalSize};
#[cfg(windows)]
...
impl wezboard_term::DownloadHandler for MuxDownloader {
