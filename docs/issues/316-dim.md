...
1. [ ] Control panel background uses HSV dimming
2. [ ] Browse mode (active): entire panel dimmed (background + text)
3. [ ] Control mode (active): entire panel normal
4. [ ] Inactive pane: entire panel dimmed
5. [ ] Visual match between background and text dimming
