...
def assert_inventory_split() -> None:
    ...
    require(remaining_row, "missing remaining renderer gap row")
    require("broader GUI/pixel parity" in remaining_row, "remaining renderer gap omitted broader GUI parity")
