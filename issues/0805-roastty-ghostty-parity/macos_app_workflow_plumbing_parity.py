...
def main() -> int:
    ...
    require_all(
        ...
        [
            ...
            ("91 rows Oracle complete", "command palette CFG-223 oracle count"),
            ("94 rows closed", "command palette CFG-223 closed count"),
        ],
    )
    require_all(
        ...
        [
            ...
            ("91 rows Oracle complete", "terminal residual CFG-223 oracle count"),
            ("94 rows closed", "terminal residual CFG-223 closed count"),
        ],
    )
    ...
    require_all(
        cfg223,
        [
            ("91 rows Oracle complete", "CFG-223 oracle count"),
            ("94 rows closed", "CFG-223 closed count"),
