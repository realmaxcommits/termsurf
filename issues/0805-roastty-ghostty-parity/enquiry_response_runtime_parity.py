...
def main() -> int:
    ...
    row_gap = require_row(runtime_inventory, "RUNTIME-009B2B2B3B2B2")
    require_all(
        row_gap,
        [
            ("Gap", "RUNTIME-009B2B2B3B2B2 status"),
    ...
    require_all(
        ...
        [
            ...
            ("Gap", "CFG-223 status"),
            ("37 rows Oracle complete", "CFG-223 oracle count"),
            ("39 rows closed", "CFG-223 closed count"),
