...
def main() -> int:
    ...
    require_all(
        row_gap,
        [
            ("Gap", "RUNTIME-007B2B status"),
            ("feature and variation", "RUNTIME-007B2B feature gap"),
            ("thicken", "RUNTIME-007B2B thicken gap"),
            ("metric adjustment", "RUNTIME-007B2B metric gap"),
            ("renderer-visible font pixel parity", "RUNTIME-007B2B pixel gap"),
        ],
    )
