...
def main() -> int:
    ...
    require_all(
        ...
        [
            ...
            ("remaining OS-controlled notification, audible bell, dock-attention, Quick Look/native preview, cursor-pixel, and external URL-handler GUI effects", "notification residual behavior"),
        ],
    )
